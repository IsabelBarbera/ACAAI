# ACAAI: Accountability by Design for Agentic AI
...
ACAAI organizes accountability into six complementary domains:
...
The domains do not represent sequential implementation phases. Instead, they describe complementary layers of accountability that operate throughout the system lifecycle. **Organizational Governance provides the foundation**, while the remaining domains establish mechanisms for human authority, bounded agent authority, operational visibility, runtime assurance and response to failures.
...
- **100+ organizational and technical controls** for operationalizing accountability across the agentic AI lifecycle;

The controls are intended to support **risk-based implementation**. Their applicability and strength should reflect factors such as the system's level of autonomy, delegated authority, operational environment and potential impact.
...
ACAAI does not propose an entirely new set of principles. Instead, it brings together existing knowledge from AI governance, cybersecurity, systems engineering, safety engineering, resilience engineering and AI assurance and translates it into a coherent framework for engineering accountability into autonomous AI systems.

The framework is intended to complement existing governance, cybersecurity, risk management and engineering practices rather than replace them.


## Status

ACAAI is an open and evolving framework.

It is not presented as a definitive or exhaustive solution. Many of the technologies, methodologies and operational practices required to implement accountability in agentic AI remain at an early stage of maturity.
...
Feedback, critique, implementation experience and research contributions are welcome.
...
> Barberá, I. (2026). ACAAI - Accountability by Design for Agentic AI: A Lifecycle Framework for Engineering Accountability in Autonomous AI Systems (Version 1.0). Zenodo. https://doi.org/10.5281/zenodo.21856004]
...
ACAAI is licensed under the [Creative Commons Attribution-ShareAlike 4.0 International License](http://creativecommons.org/licenses/by-sa/4.0/).
...
*Accountability should not only be assigned. It should be engineered.*
